...
namespace NZAttractionSystem.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public BookingsController(CustomersDbContext context)
        {
            _context = context;
        }
        ...
        {
            var customersDbContext = _context.Booking.Include(b => b.Attraction).Include(b => b.Customer);
        ...
        {
            ViewData["AttractionId"] = new SelectList(_context.Attraction, "Id", "Address");
